...
6. Write a program that prints all possible different combinations of two digit
...
13. Write a function in C that inserts a number into a sorted singly linked list14. Write a program that prints the ASCII alphabet, in reverse order, alternating lowercase and uppercase (z in lowercase and Y in uppercase) , not followed by a new line.
